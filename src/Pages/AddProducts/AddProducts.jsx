                                ...
                                <form onSubmit={handleProductAdd}>
                                    <div className="md:flex flex-row md:space-x-4 w-full text-xs">
                                        <div className="mb-3 space-y-2 w-full text-xs">
                                            ...
                                            <input name="name" placeholder="Product Name" className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" id="integration_shop_name" />
                                    ...
                                    <div className="mb-3 space-y-2 w-full text-xs">
                                        ...
                                        <div className="flex flex-wrap items-stretch w-full mb-4 relative">
                                            ...
                                            <input name="photo" required="required" type="text" className="flex-shrink flex-grow leading-normal w-px flex-1 border border-l-0 h-10 border-grey-light rounded-lg rounded-l-none px-3 relative focus:border-blue focus:shadow" placeholder="https://" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                                        ...
                                        <input type="submit" value="Add Product" className="mb-2 md:mb-0 bg-green-400 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-500" />
                                    </div>
                                </form>
                            </div>
                        </div>
